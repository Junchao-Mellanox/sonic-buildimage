...
def run_command(command):
    ...
    """
    return subprocess.check_output(command, shell=True, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
class SyslogHandler:
    ...
    def update_syslog_config(self, data):
        ...
        run_command('sonic-cfggen -d -t /usr/share/sonic/templates/rsyslog-container.conf.j2 -a "{{\\"target_ip\\": \\"{}\\", \\"container_name\\": \\"{}\\" }}"  > {}'.format(self.target_ip, container_name, self.TMP_SYSLOG_CONF_PATH))
